...
def main():
    ...
    load_data = bool(int(Args.load_data))
    BA = bool(int(Args.BA))
...
#     savepath = "../outputs_noBA/"
    ...
    for i in range(2, total_images):
        ...
        for j in range(0, i):
            ...
            print(i+1, j+1, '|| Before PnP optimization: ', PnP_error, 'After PnP optimization :', LT_error)        
            ...
            print(i+1,j+1, '|| Before LT optimization: ', LT_error, 'After NLT optimization :', nLT_error)
        ...
        if BA:
            ...
            for j in range(0, i):
                ...
                print(i+1, j+1, '| Error after BA :', BA_error)
...
#     if BA:
#         print( 'Performing Bundle Adjustment  for all images'  )
